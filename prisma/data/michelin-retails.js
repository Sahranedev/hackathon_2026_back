...
exports.michelinRetails = void 0;
const michelinRetailSources = [
    {
        region: 'EUN',
        country: 'UK',
        name: 'Tredz',
...
const fakeLocationByCountry = {
    UK: {
        address: 'Unit 4, Cycle Park, 18 Velodrome Way, London E20 3HB, United Kingdom',
        longitude: -0.1276,
        latitude: 51.5074,
    ...
    NL: {
        address: 'Fietsenwinkel Amsterdam, Haarlemmerdijk 89, 1013 KC Amsterdam, Netherlands',
        longitude: 4.9041,
        latitude: 52.3676,
...
function fakePhone(prefix, index) {
    const suffix = String(1000 + index * 137).slice(-4);
    return `${prefix} ${suffix}`;
}
function offsetCoordinate(value, index) {
    return Number((value + index * 0.012).toFixed(4));
}
exports.michelinRetails = michelinRetailSources.map((source, index) => {
...
//# sourceMappingURL=michelin-retails.js.map